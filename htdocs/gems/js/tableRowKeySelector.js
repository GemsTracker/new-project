...
jQuery.widget("ui.tableRowKeySelector", {
    ...
    _init: function() {
        ...
        var find, link, title;
        var keys = {Down: '\u2193', End: 'End', Home: 'Home', Left: '\u2190', PgDn: 'PgDn', PgUp: 'PgUp', Right: '\u2192', Up: '\u2191'};
    ...
    listener: function(e) {
        ...
        switch(key) {
            ...
            case 33:  // PgUp
                var link = jQuery('a.keyPgUp[href]', this.element);
                if (link.length > 0) {
                    e.stopPropagation();
            ...
            case 34:  // PgDn
                var link = jQuery('a.keyPgDn[href]', this.element);
                if (link.length > 0) {
                    e.stopPropagation();
                    location.href = link.attr('href');
                    return;
            ...
            case 35:  // End
                if (e.ctrlKey) {
                    ...
                    var link = jQuery('a.keyEnd[href]', this.element);
                    if (link.length > 0) {
                        e.stopPropagation();
                        location.href = link.attr('href');
                        return;
            ...
            case 36:  // Home
                if (e.ctrlKey) {
                    ...
                    var link = jQuery('a.keyHome[href]', this.element);
                    if (link.length > 0) {
                        e.stopPropagation();
                        location.href = link.attr('href');
                        return;
            ...
            case 38:  // Up
                if (e.ctrlKey) {
                    var link = jQuery('a.keyCtrlUp[href]', this.element);
                    if (link.length > 0) {
                        e.stopPropagation();
                        location.href = link.attr('href');
                        return;
            ...
            case 40: // down
                if (e.ctrlKey) {
                    var link = jQuery('a.keyCtrlDown[href]', this.element);
                    if (link.length > 0) {
                        e.stopPropagation();
                        location.href = link.attr('href');
                        return;
